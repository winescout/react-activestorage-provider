...
function buildUrl(_ref) {
  var protocol = _ref.protocol,
      ...
      path = _ref.path;
  if (!host) return path;
  var buildProtocol = protocol ? "".concat(protocol.split(':')[0], "://") : '//';
...
function () {
  ...
  createClass(Upload, [{
    ...
    get: function get() {
      ...
      return buildUrl(objectSpread({}, origin, {
        path: directUploadsPath
      }));
    }
  }]);
...
function (_React$Component) {
  ...
  createClass(ActiveStorageProvider, [{
    ...
    value: function render() {
      ...
      return React.createElement(DirectUploadProvider, _extends_1({}, props, {
        origin: {
          host: host,
          port: port,
          protocol: protocol
    ...
    value: function () {
      ...
      regenerator.mark(function _callee2(signedIds) {
        var _this$props2, endpoint, multiple, protocol, host, port, path, method, attribute, model, body, response;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                protocol = endpoint.protocol, host = endpoint.host, port = endpoint.port, path = endpoint.path, method = endpoint.method, attribute = endpoint.attribute, model = endpoint.model;
...
exports.default = ActiveStorageProvider;
exports.DirectUploadProvider = DirectUploadProvider;
